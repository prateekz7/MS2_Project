...
import com.pct.parser.model.OfficialPayloadField;
...
public class ParseTLVReportConstants {
	...
	private int sequenceNumber = MAX_INT_NUMBER_VALUE;
...
//  public static ArrayList<OfficialPayloadField> TLV_GENERAL_FIELDS_MAP;
//    static {
//        TLV_GENERAL_FIELDS_MAP = new ArrayList<OfficialPayloadField>(NUM_TLV_GENERAL_FIELD_TYPES);
//
//        OfficialPayloadField opf = new OfficialPayloadField("Speed + Heading", 2, new byte[]{1, 1}); 
//        TLV_GENERAL_FIELDS_MAP.add(opf);
//
//        opf = new OfficialPayloadField("Altitude", 2, null); /* 1st */
//        TLV_GENERAL_FIELDS_MAP.add(opf);
//
//        opf = new OfficialPayloadField("Accuracy", 2, new byte[]{1, 1}); /* 2nd */
//        TLV_GENERAL_FIELDS_MAP.add(opf);
//
//        opf = new OfficialPayloadField("Voltage", 2, new byte[]{1, 1}); /* 3rd */
//        TLV_GENERAL_FIELDS_MAP.add(opf);
//
//        opf = new OfficialPayloadField("GPIO", 1, null); /* 4th */
//        TLV_GENERAL_FIELDS_MAP.add(opf);
//
//        opf = new OfficialPayloadField("Odometer", 4, null); /* 5th */
//        TLV_GENERAL_FIELDS_MAP.add(opf);
//
//        opf = new OfficialPayloadField("Undefined", 0, null); /* 6th */
//        TLV_GENERAL_FIELDS_MAP.add(opf);
//
//        opf = new OfficialPayloadField("Undefined", 0, null); /* 7th */
//        TLV_GENERAL_FIELDS_MAP.add(opf);
//    }
//
//
//    /////////////////////////////////////// TLV Accelerometer Masked Fields ////////////////////////////////////////////
//    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//
//    public static final int TLV_ACCELEROMETER_MASK_FIELD_LEN = 1;
//    public static final int NUM_TLV_ACCELEROMETER_FIELD_TYPES = 8;
//
//    public static final int AXIS_DATA_CASE = 0;
//    public static final int CALIB_CASE = 1;
//    public static final int RAW_DATA_CASE = 2;
//
//    public static ArrayList<OfficialPayloadField> TLV_ACCELEROMETER_FIELDS_MAP;
//    static {
//        TLV_ACCELEROMETER_FIELDS_MAP = new ArrayList<OfficialPayloadField>(NUM_TLV_ACCELEROMETER_FIELD_TYPES);
//
//        OfficialPayloadField opf = new OfficialPayloadField("Axis Data", 6, new byte[]{2, 2, 2}); /* 0 */
//        TLV_ACCELEROMETER_FIELDS_MAP.add(opf);
//
//        opf = new OfficialPayloadField("Calibration Data", 6, new byte[]{2, 2, 2}); /* 1st */
//        TLV_ACCELEROMETER_FIELDS_MAP.add(opf);
//
//        opf = new OfficialPayloadField("Raw Data", 6, new byte[]{2, 2, 2}); /* 2nd */
//        TLV_ACCELEROMETER_FIELDS_MAP.add(opf);
//
//        opf = new OfficialPayloadField("Undefined", 0, null); /* 3th */
//        TLV_ACCELEROMETER_FIELDS_MAP.add(opf);
//
//        opf = new OfficialPayloadField("Undefined", 0, null); /* 4th */
//        TLV_ACCELEROMETER_FIELDS_MAP.add(opf);
//
//        opf = new OfficialPayloadField("Undefined", 0, null); /* 5th */
//        TLV_ACCELEROMETER_FIELDS_MAP.add(opf);
//
//        opf = new OfficialPayloadField("Undefined", 0, null); /* 6th */
//        TLV_ACCELEROMETER_FIELDS_MAP.add(opf);
...
//    }
//
//    /////////////////////////////////////// TLV Network Masked Fields //////////////////////////////////////////////////
//    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//
//    public static final int     TLV_NETWORK_MASK_FIELD_LEN = 1;
//    public static final int     TLV_NETWORK_SELECTOR_FIELD_LEN = 1;
...
//
	...
	public static ArrayList<OfficialPayloadField> TLV_NETWORK_FIELDS_MAP;
	static {
		TLV_NETWORK_FIELDS_MAP = new ArrayList<OfficialPayloadField>(NUM_TLV_NETWORK_FIELD_TYPES);

		OfficialPayloadField opf = new OfficialPayloadField("Service", 1, null); /* 1nst */
		TLV_NETWORK_FIELDS_MAP.add(opf);

		opf = new OfficialPayloadField("MCC-MNC", 4, new byte[] { 2, 2 }); /* 2nd */
		TLV_NETWORK_FIELDS_MAP.add(opf);

		opf = new OfficialPayloadField("Tower-ID", 6, null); /* 3rd */
		TLV_NETWORK_FIELDS_MAP.add(opf);

		opf = new OfficialPayloadField("Tower-Centroid", 8, new byte[] { 4, 4 }); /* 4th */
		TLV_NETWORK_FIELDS_MAP.add(opf);

		opf = new OfficialPayloadField("Band", 5, new byte[] { 1, 2, 2 }); /* 5th */
		TLV_NETWORK_FIELDS_MAP.add(opf);

		opf = new OfficialPayloadField("RSSI", 1, null); /* 6th */
		TLV_NETWORK_FIELDS_MAP.add(opf);

		opf = new OfficialPayloadField("RX+TX+EC", 6, new byte[] { 1, 1, 1 }); /* 5th */
		TLV_NETWORK_FIELDS_MAP.add(opf);
